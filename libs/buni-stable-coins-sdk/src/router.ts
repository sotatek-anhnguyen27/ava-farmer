...
import { BNB, CurrencyAmount, ETHER, Percent, Trade } from './entities'
...
/**
 * The parameters to use in the call to the BuniCornExchange Router to execute a trade.
 */
export interface SwapParameters {
  /**
   * The method to call on the BuniCornExchange Router.
   */
  methodName: string
  /**
...
/**
 * Represents the BuniCornExchange Router, and has static methods for helping execute trades.
 */
