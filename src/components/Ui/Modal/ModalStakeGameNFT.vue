      ...
      <template #default>
        <div class="header" :class="_isThemeGame && 'game-header'">
          ...
          >
            ...
            />
            <div>
              You can't unstake NFT once the farm distributed reward!
            </div>
          </div>
        </div>
        <div class="content">
          <div class="nft-row nft-header-label">
            ...
            <div class="nft-name">NFT Name (available)</div>
            <div class="hash-rate">
          ...
          <template v-if="listNFTs.length > 0">
            ...
            >
              ...
              <div class="nft-name">{{ nftItem.nameAsText }}</div>
              <div class="hash-rate">{{ nftItem.hashRate }}</div>
            </div>
          </template>
          <template v-else>
