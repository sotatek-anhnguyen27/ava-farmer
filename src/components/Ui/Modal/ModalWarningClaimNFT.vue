<template>
  <UiModal
    :open="open"
    @close="$emit('closeModalWarningClaimNFT')"
    style="max-width: 380px;"
    class="modal-stake"
    :class="_isThemeGame ? 'game' : ''"
  >
    <template #default>
      <div class="header" :class="_isThemeGame && 'game-header'" v-html="$t('warning_claim_vesting.title')">
      </div>
      <div class="content">
        <div class="flex" :class="_isThemeGame ? 'game' : ''">
          ...
          >
            <p>🚨 {{ $t('warning_claim_vesting.disclaimers')}}:</p>
            <p>{{ $t('warning_claim_vesting.disclaimer1') }}</p>
          </div>
        </div>
        <div class="button-flex">
          ...
          >
            ...
            <span v-else>{{ $t('warning_claim_vesting.button') }}</span>
          </UiButton>
        </div>
      </div>
    </template>
