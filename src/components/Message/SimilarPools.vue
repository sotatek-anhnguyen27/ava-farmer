<template>
  <div
    ...
    :class="_isThemeGame && 'game-border-message-similar-pool'"
  >
    <Icon v-if="!_isThemeGame" name="info" size="22" class="mr-4" />
    <img
      v-else
      src="~/@/assets/icon/game/info.png"
      style="width: 30px;"
...
#info {
  ...
  background: $panel-background-info;
  color: $info;
...
#info.game-border-message-similar-pool {
  background: $game-similar-pool-bg-color !important;
